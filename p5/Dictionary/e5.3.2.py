...
# Problem: Please write a function named factorials(n: int),
...
# A reminder: the factorial of the number n is written n!
# and is calculated by multiplying the number by each integer smaller than itself.
