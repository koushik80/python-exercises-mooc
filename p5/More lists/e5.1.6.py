# E-5.1.6: Sudoku: check block

# Problem:Please write a function named block_correct(sudoku: list, row_no: int, column_no: int),
...
# and these are located at indexes(0, 0), (0, 3), (0, 6), (3, 0), (3, 3), (3, 6), (6, 0), (6, 3) and (6, 6). Such restrictions on indexes should not be implemented here.
