...
#Problem: Please write a program which asks the user to type in an integer number.
#If the user types in a number equal to or below 0,
#the execution ends. Otherwise the program prints out the factorial of the number.
