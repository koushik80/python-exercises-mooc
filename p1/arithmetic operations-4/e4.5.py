#E4.5: Fix the code: Product

# Problem:This program asks the user for three numbers.
#The program then prints out their product,
#that is, the numbers multiplied by each other.
